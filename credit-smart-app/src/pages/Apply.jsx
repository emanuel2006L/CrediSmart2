...
function update(f,v){setForm(p=>({...p,[f]:v}));setSuccessMsg("");}
...
if(Object.keys(finalErrors).length){setErrors(finalErrors);setSuccessMsg("");return;}

setRequests(p=>[...p,{...form,id:Date.now(),monthly:Math.round(monthlyInstallment)}]);

setForm({name:"",docType:"",docNumber:"",phone:"",email:"",creditId:"",amount:"",term:""});
setErrors({});
